...
const PatientInfo = ({ patient }: PatientInfoProps) => {
  ...
  return (
    <div className="bg-white rounded-2xl p-5">
      ...
      <div className="space-y-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <p className="text-[#072635] text-sm leading-[19px] mb-1">Date Of Birth</p>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <p className="text-[#072635] text-sm leading-[19px] mb-1">Contact Info</p>
            <p className="text-[#072635] font-bold text-sm leading-[19px]">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <p className="text-[#072635] text-sm leading-[19px] mb-1">Emergency Contacts</p>
            <p className="text-[#072635] font-bold text-sm leading-[19px]">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <p className="text-[#072635] text-sm leading-[19px] mb-1">Insurance Provider</p>
            <p className="text-[#072635] font-bold text-sm leading-[19px]">
      ...
      <button type='button' className="w-full mt-10 bg-[#01F0D0] hover:bg-[#00D4B5] transition-colors text-[#072635] font-bold text-sm leading-[19px] py-3 px-6 rounded-full">
